...
const FormRoleSearching = ({dataFormRole,className,fetchData}) => {
   ...
   const checkFormValidity = (changedValues,allValues) => {
    const { status, search_query } = allValues;
   ...
   return (
    ...
    >
        ...
        <Form.Item name="search_query" className='py-2'>
          <Input type='text' placeholder="Tìm kiếm theo tên" style={{ width: 200 }} />
        </Form.Item>
...
export default FormRoleSearching